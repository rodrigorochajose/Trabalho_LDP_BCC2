...
SQL = "SELECT id, nome, descricao, valor, obs, ativo, competencia FROM despesa WHERE ativo="& Ativo &" AND id_usuario="& Session("user") &" ORDER BY competencia"
...
<table id="tabela_conteudo">
    <% While Not Reg.EOF %>
        <tr>
            ...
            <td style="width: 7%">
                <a href="despesa_atualizar.asp?id=<%= Reg("id").Value %>" title="Atualizar Despesa" class="btn-floating btn-large waves-effect blue accent-4 botoes">
